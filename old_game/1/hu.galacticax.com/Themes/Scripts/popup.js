...
$(document).ready(function()
{
	...
	$("span.g6t").each(
		function (i) {
			...
			ido=60*(60*ido[idolen-2]+parseInt(ido[idolen-1],10))
			tick=60*(60*tick[1]+parseInt(tick[2],10))
			var most=new Date()
...
*/
	...
	else
	{
		...
		// helpUrlBase = "http://drupal.galacticax.com/reference/" + m[2] + '/';
	}
...
function docreditextra(e)
{
    location.href = 'credit_info.html?action=CLEAR';
}
